...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Gols> gols = lerCSV(urlGols,dados -> new Gols(dados[0], dados[1], dados[2], dados[3], dados[4], dados[5]));
        ...
        List<Full> full = lerCSV(urlFull, dados -> new Full(dados[0], dados[1], dados[2], dados[3], dados[4], dados[5], dados[6], dados[7], dados[8], dados[9], dados[10], dados[11], dados[12], dados[13], dados[14], dados[15]));
        ...
        List<Cartoes> cartoes = lerCSV(urlCartoes, dados -> new Cartoes(dados[0], dados[1], dados[2], dados[3], dados[4], dados[5], dados[6], dados[7]));
        ...
        DateTimeFormatter dataFormatada = DateTimeFormatter.ofPattern("d/M/yyyy");

        List<String> times = full.stream()
                .filter(f -> {
                    LocalDate data = LocalDate.parse(f.getData(), dataFormatada);
        ...
        System.out.println("Time com mais vitórias em 2008: " + timeMaisVitorioso + " que teve " + qtdVitoriasTimeMaisVitorioso + " vitórias.");
        ...
        System.out.println("Jogador com mais gols: " + jogadorComMaisGols + " que fez " + qtdGolsJogadorComMaisGols + " gols.");
        ...
        System.out.println("Jogador com mais gols de pênalti: " + jogadorComMaisGolsPenalty + " que fez " + qtdGolsJogadorComMaisGolsPenalty + " gols de pênalti.");

        // 4) O jogador que mais fez gols contra
        ...
        System.out.println("Jogador com mais gols contra: " + jogadorComMaisGolsContra + " que fez " + qtdGolsJogadorComMaisGolsContra + " gols contra.");

        // 5) O jogador que mais recebeu cartão amarelo
        ...
        System.out.println("Jogador com mais cartões amarelos: " + jogadorComMaisCartoesAmarelos + " que levou " + qtdCartoesJogadorComMaisCartoesAmarelos + " cartões amarelos.");
        
        // 6) O jogador que mais recebeu cartão vermelho
        List<String> jogadoresCartoesVermelhos = cartoes.stream()
            .map(Cartoes::getAtleta)
            .distinct()
            .sorted()
            .toList();

        String jogadorComMaisCartoesVermelhos = "";
        long qtdCartoesJogadorComMaisCartoesVermelhos = 0;

        for (String jogador : jogadoresCartoesVermelhos) {
        long qtdCartoesVermelhos = cartoes.stream()
                .filter(c -> c.getAtleta().equals(jogador))
                .filter(c -> c.getCartao().equals("Vermelho"))
                .count();

        if (qtdCartoesVermelhos > qtdCartoesJogadorComMaisCartoesVermelhos) {
            qtdCartoesJogadorComMaisCartoesVermelhos = qtdCartoesVermelhos;
            jogadorComMaisCartoesVermelhos = jogador;
        }
    }
        System.out.println("Jogador com mais cartões vermelhos: " + jogadorComMaisCartoesVermelhos + " que levou " + qtdCartoesJogadorComMaisCartoesVermelhos + " cartões vermelhos.");
}
